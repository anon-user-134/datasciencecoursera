...
plot(pwr$DateTime, pwr$Sub_metering_1 , pch= "." , ylab = "Energy Sub metering", xlab = "")

lines(pwr$DateTime, pwr$Sub_metering_3, pch= ".", col = "blue")

lines(pwr$DateTime, pwr$Sub_metering_2, pch= ".", col = "red")

lines(pwr$DateTime, pwr$Sub_metering_1, pch= ".")

legend("topright", lty="solid", col=c("black", "blue", "red") , legend = c("Sub_metering_1", "Sub_metering_2", 
                                                                           "Sub_metering_3") )

title(main = "Plot 3" , adj =0, outer = TRUE, line = -1) 
